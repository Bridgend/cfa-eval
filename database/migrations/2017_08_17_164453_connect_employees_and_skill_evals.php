...
class ConnectEmployeesAndSkillEvals extends Migration
{
    /**
    * Run the migrations.
    *
    ...
    */
    public function up()
    {
        Schema::table('skill_evals', function (Blueprint $table) {
    ...
    */
    public function down()
    {
        Schema::table('skill_evals', function (Blueprint $table) {
            ...
            $table->dropForeign('skill_evals_employee_id_foreign');
