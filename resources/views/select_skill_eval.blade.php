        ...
        <div class='col-md-8 col-md-offset-2'>
            <div class='panel panel-default'>
                <div class='panel-heading'>
                    <h4>View Skill Evaluation</h4>
                </div>
                <div class='panel-body'>

                    <form class='form-horizontal' role='form' method='POST' action='/skill-eval/view'>
                        {{ csrf_field() }}
...
$('#employee').on('change', function(e){
    ...
    //ajax
    $.get('/api/skill-eval-dropdown?emp_id=' + emp_id, function(data) {
        //success data
        $('#evaluation').empty();
